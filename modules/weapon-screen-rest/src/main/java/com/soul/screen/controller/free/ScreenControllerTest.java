...
public class ScreenControllerTest {
    ...
    public ScreenSrAndRtData getUnderwarterResponseTime(){
        ...
        sc1.setName("fxmb");
        sc1.setType("1");
        sc1.setValue(random.nextDouble()*100);
        ScreenUniversalData sc2 = new ScreenUniversalData();
        sc2.setText("生成态势");
        sc2.setName("scts");
        sc2.setType("2");
        ...
        sc3.setName("scfa");
        sc3.setType("3");
        sc3.setValue(random.nextDouble()*100);
        ScreenUniversalData sc4 = new ScreenUniversalData();
        sc4.setText("确认方案");
        sc4.setName("qrfa");
        sc4.setType("4");
        sc4.setValue(random.nextDouble()*100);
        ScreenUniversalData sc5 = new ScreenUniversalData();
        sc5.setText("生成诸元");
        sc5.setName("sczy");
        sc5.setType("5");
        sc5.setValue(random.nextDouble()*100);
        ScreenUniversalData sc6 = new ScreenUniversalData();
        sc6.setText("作战执行");
        sc6.setName("zzzx");
        sc6.setType("6");
        sc6.setValue(random.nextDouble()*100);
        list.add(sc1);
        list.add(sc2);
        list.add(sc3);
        list.add(sc4);
